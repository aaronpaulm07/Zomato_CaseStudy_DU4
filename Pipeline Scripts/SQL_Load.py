...
# Insert cuisine types into CuisineCategories table if they do not exist
        ...
        for category_id in category_ids:
            ...
            connection.commit()
                ...
                logging.error("Error while inserting data:", error)
                logging.warning("Problematic row:", data)
...
def clear_tables(connection):
    try:
        ...
        ("Error while clearing tables:", error)
...
if connection:
    ...
    logging.critical("Could not connect to DB - SQL_Load")
    print("Could not connect to DB - SQL_Load")
    raise FileNotFoundError("There should be one folder") 