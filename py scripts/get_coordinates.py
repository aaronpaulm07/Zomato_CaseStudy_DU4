...
csv_file_path = r"D:\DU Training\Case Study-Zomato\dataset-pipeline\split_cuisine_dataset.csv"

# Specify the path for the output CSV file
output_csv_file = r"D:\DU Training\Case Study-Zomato\dataset-pipeline\coordinates_scrapped_dataset.csv"

inter_output_csv_file = r"D:\DU Training\Case Study-Zomato\dataset-pipeline\coordinates_scrapped_dataset_intermediate.csv"
...
if __name__ == '__main__':
        ...
        # Read the CSV file into a DataFrame
         ...
         print("Reading the CSV file and logging the initial dataset size")
         if os.path.isfile(inter_output_csv_file):
            ...
            sample_top_restaurants = sorted_df.head(100)
            sample_low_restaurants = sorted_df.tail(100)
    ...
    logging.error("CSV file not found at: %s", csv_file_path)
